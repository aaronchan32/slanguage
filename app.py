...
def renderSocialMediaTemplate(nameHTML, socialPlatform):
    ...
    try:
        ...
        socialMediaRender = render_template(nameHTML, template=analyzedData.getTemplateSetup(
        ), socialPlatform=socialPlatform, showDownload=True, names=names)
...
def socialMedia(nameHTML, socialPlatform):
    # When form is submitted (When user press Download button)
